...
class CartItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Check if we need to refresh the cart when currency changes
    final selectedCurrency = LocalStorage.getSelectedCurrency();
                    ...
                    Padding(
                      ...
                      child: Text(
                        AppHelpers.numberFormat(
                          ...
                          // Don't apply rate - prices are already converted
                        ),
